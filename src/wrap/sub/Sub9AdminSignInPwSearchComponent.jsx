...
export default function Sub9AdminSignInPwSearchComponent(){
    ...
    const onSubmitPwSearch=(e)=>{
        ...
        axios({
            url: 'http://pse990813.dothome.co.kr/greekday/greekday_admin_pw_search_name_id_email_select.php',
            method: 'POST',
            data: formData
        })
        .then((res)=>{
    ...
    return (
        <div id='sub9'>
            <div className="container">
                <div className="title">
                    <h2 className='title-txt'>관리자 비밀번호 찾기</h2>
                </div>
