...
export default function Sub10ChildMemberUpdate(){
    ...
    const onChangeSNSAgree=(e)=>{
        setState({
            ...state,
            snsAgree: e.target.value
        })
    }
    const onChangeEmailAgree=(e)=>{
        setState({
            ...state,
            emailAgree: e.target.value
        })
    }
    ...
    const onSubmitSignUpForm=(e)=>{
        ...
        if(state.pw === '' && state.pwCheck === ''){
            ...
            axios({
                url: 'http://pse990813.dothome.co.kr/greekday/greekday_memberInfo_update.php',
                method: 'POST',
                data: formData
            })
            .then((res)=>{
    ...
    return (             
        <div className="memberUpdate">  
            <div className="container">
                <div className="title">
                    <h2 className='title-txt'>회원정보수정</h2>
                </div>
                <div className="step2">
                        ...
                        <ul className='signup-form'>
                            ...
                            <li className='list radio sns'>
                                <div className="list-box">
                                    ...
                                    <div className="input-box">  
                                        <label htmlFor="userSNSAgree">                                                
                                            <input 
                                                type="radio" 
                                                name='userSNSAgree' 
                                                id='userSNSAgree' 
                                                value={'수신함'} 
                                                onChange={onChangeSNSAgree}
                                                checked={state.snsAgree.includes('수신함')}
                                            />
                                            <span>수신함</span>
                                        </label>
                                        <label htmlFor="userSNSNoAgree"> 
                                            <input 
                                                type="radio" 
                                                name='userSNSNoAgree' 
                                                id='userSNSNoAgree' 
                                                value={'수신안함'} 
                                                onChange={onChangeSNSAgree}
                                                checked={state.snsAgree.includes('수신안함')}
                                            />
                                            <span>수신안함</span>
                                        </label>
                                    </div>
                            ...
                            <li className='list radio email'>
                                <div className="list-box">
                                    ...
                                    <div className="input-box">  
                                        <label htmlFor="userEmailAgree">                                                
                                            <input 
                                                type="radio" 
                                                name='userEmailAgree' 
                                                id='userEmailAgree' 
                                                value={'수신함'} 
                                                onChange={onChangeEmailAgree}
                                                checked={state.emailAgree.includes('수신함')}
                                            />
                                            <span>수신함</span>
                                        </label>
                                        <label htmlFor="userEmailNoAgree"> 
                                            <input 
                                                type="radio" 
                                                name='userEmailNoAgree' 
                                                id='userEmailNoAgree' 
                                                value={'수신안함'} 
                                                onChange={onChangeEmailAgree}
                                                checked={state.emailAgree.includes('수신안함')}
                                            />
                                            <span>수신안함</span>
                                        </label>
                                    </div>
