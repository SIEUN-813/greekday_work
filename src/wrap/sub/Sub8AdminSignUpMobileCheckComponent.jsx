...
export default function Sub8AdminSignUpMobileCheckComponent(){
            ...
            .then((res)=>{
                if(res.status === 200){
                    if(res.data === 1){
                        ...
                        axios({
                            url: 'http://pse990813.dothome.co.kr/greekday/greekday_admin_mobile_check_insert.php',
                            method: 'POST',
                            data: formData
                        }) 
                        .then((res)=>{
