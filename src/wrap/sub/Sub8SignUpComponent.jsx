...
export default function Sub8SignUpComponent(){
    ...
    const onClickMobileCheck=(e)=>{
        e.preventDefault();
        navigete('/sub8SignUpMobileCheck');
    }
    ...
    const onKeyUpId=(e)=>{
        ...
        if(regexp1.test(value) === false || regexp2.test(value) === false){         
            ...
            axios({
                url: 'http://pse990813.dothome.co.kr/greekday/greekday_id_duplicate_check.php',
                method: 'POST',
                data: formData
            })
            .then((res)=>{
    ...
    const onChangelifeMember=(e)=>{
        setState({
            ...state,
            lifeMember: e.target.value
        })
    }
    ...
    const onSubmitSignUpForm=(e)=>{
        ...
        if(state.id === ''){
            ...
            axios({
                url: 'http://pse990813.dothome.co.kr/greekday/greekday_signup_insert.php',
                method: 'POST',
                data: formData
            })
            .then((res)=>{
                if(res.status===200){       
                   if(res.data===1){       
                    confirmModalMethod('그릭데이 회원가입을 진심으로 감사드립니다');
                    navigete('/sub8SignUpComplete',
                        {             
                            state: {
                                id: state.id,
                            ...
                            <li> 
                                <label htmlFor="memberType1">                                                
                                    <input 
                                        ...
                                        checked={state.memberType.includes('개인회원')}
                                    />
                                    <span>개인회원</span>
                                </label>
                                <label htmlFor="memberType2">                                                
                                    <input 
                                        type="radio" 
                                        name='memberType' 
                                        id='memberType2' 
                                        value={'사업자회원'} 
                                        onChange={onChangeMemberType}
                                        checked={state.memberType.includes('사업자회원')}
                                    />
                                    <span>사업자회원</span>
                                </label>
                                <label htmlFor="memberType3">                                                
                                    <input 
                                        type="radio" 
                                        name='memberType' 
                                        id='memberType3' 
                                        value={'외국인회원(foreigner)'} 
                                        onChange={onChangeMemberType}
                                        checked={state.memberType.includes('외국인회원(foreigner)')}
                                    />
                ...
                <div className="step2">
                    ...
                    <form autoComplete='off' onSubmit={onSubmitSignUpForm}>
                        <ul className='signup-form'>
                            ...
                            <li className='list radio member'>
                                <div className="list-box">
                                    <div className="top-box">                                            
                                        <label>
                                            <span>평생회원</span>
                                    ...
                                    <div className="input-box">  
                                        <label htmlFor="userAgree">                                                
                                            <input 
                                                ...
                                                id='userAgree' 
                                                value={'동의함'} 
                                                onChange={onChangelifeMember}
                                                checked={state.lifeMember.includes('동의함')}
                                            />
                                            <span>동의함</span>
                                        </label>
                                        <label htmlFor="userNoAgree"> 
                                            <input 
                                                type="radio" 
                                                name='userNoAgree' 
                                                id='userNoAgree' 
                                                value={'동의안함'} 
                                                onChange={onChangelifeMember}
                                                checked={state.lifeMember.includes('동의안함')}
                                            />
                                            <span>동의안함</span>
                                        </label>
                                    </div>
                                ...
                                <div className="list-box">
                                    <div className="check-box">  
                                        <input 
                                            ...
                                            checked={state.serviceAgree.length===3}
                                        />
                                ...
                                <div className="list-box">
                                    <div className="check-box">  
                                        <input 
                                            ...
                                            checked={state.serviceAgree.includes('[필수] 이용약관 동의')}
                                        />
                                ...
                                <div className="list-box">
                                    <div className="check-box">  
                                        <input 
                                            ...
                                            onChange={onChangeServiceCheck}
                                            checked={state.serviceAgree.includes('[필수] 개인정보 수집 및 이용 동의')}
                                        />
                                ...
                                <div className="list-box">
                                    <div className="check-box">  
                                        <input 
                                            ...
                                            value={'[선택] 쇼핑정보 수신 동의'}
                                            onChange={onChangeServiceCheck}
                                            checked={state.serviceAgree.includes('[선택] 쇼핑정보 수신 동의')}
                                        />
